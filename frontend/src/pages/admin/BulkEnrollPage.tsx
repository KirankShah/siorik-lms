...
export function BulkEnrollPage() {
  ...
  return (
    <div>
      <h1 className="text-lg font-semibold text-slate-900">Bulk Enroll</h1>
      ...
      <div className="mt-4 space-y-4 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <button
          type="button"
          disabled={!courseSlug || !file || isSubmitting}
      ...
      {result && (
        <div className="mt-4 space-y-3 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
