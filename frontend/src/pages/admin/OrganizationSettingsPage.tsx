...
function SettingsForm({
  ...
  const questionCount = Number(draft.questions_per_attempt)
  const totalMinutes = Number(draft.total_exam_minutes)
  const calculatedSeconds = questionCount > 0 && totalMinutes > 0
    ...
    <Card className="mt-6 max-w-xl">
      ...
      <div className="mt-4 space-y-4">
        ...
        <Input
          ...
          label="Total exam duration (minutes)"
          type="number"
          min={5}
        ...
        <div>
          <Input
            ...
            label="Seconds per question (calculated automatically)"
            type="number"
          ...
          <p className="mt-1 text-xs text-neutral-500">
            Total duration in seconds ÷ number of questions, rounded down. Each question has its own countdown.
          </p>
        </div>
        <Input
