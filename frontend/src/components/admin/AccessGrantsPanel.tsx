...
export function AccessGrantsPanel({ courseSlug, grants, organizations, onChanged }: AccessGrantsPanelProps) {
  ...
  return (
    <Card>
      <h2 className="text-sm font-semibold text-neutral-900">Organization Access</h2>
      ...
      <ul className="mt-3 space-y-2">
        ...
        {grants.length === 0 && <li className="text-sm text-neutral-400">No organizations have access yet.</li>}
      </ul>
